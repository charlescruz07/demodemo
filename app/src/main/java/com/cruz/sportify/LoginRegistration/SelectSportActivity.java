    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.badmintonImg:
                if(badmintonImg.getDrawable().getConstantState().equals(getResources().getDrawable(R.drawable.cat_inactive_badminton).getConstantState())){
            ...
            case R.id.volleyballImg:
                if(volleyballImg.getDrawable().getConstantState().equals(getResources().getDrawable(R.drawable.cat_inactive_volleyball).getConstantState())){
                ...
                break;
            case R.id.soccerImg:
                if(soccerImg.getDrawable().getConstantState().equals(getResources().getDrawable(R.drawable.cat_inactive_soccer).getConstantState())){
            ...
            case R.id.pingpongImg:
                if(pingpongImg.getDrawable().getConstantState().equals(getResources().getDrawable(R.drawable.cat_inactive_table_tennis).getConstantState())){
            ...
            case R.id.bowlingImg:
                if(bowlingImg.getDrawable().getConstantState().equals(getResources().getDrawable(R.drawable.cat_inactive_bowling).getConstantState())){
                ...
                break;
            case R.id.tennisImg:
                if(tennisImg.getDrawable().getConstantState().equals(getResources().getDrawable(R.drawable.cat_inactive_lawn_tennis).getConstantState())){
                ...
                break;
            case R.id.golfImg:
                if(golfImg.getDrawable().getConstantState().equals(getResources().getDrawable(R.drawable.cat_inactive_golf).getConstantState())){
